...
public class Main {
    public static void main(String[] args) {
        ...
        TurnOnTariff turnOnFirst = new TurnOnTariff("Смотри", highlights, 650, 30, bulletPoints);
        ...
        ModemTariff modemTariffThird = new ModemTariff("МегаФон — Онлайн", modemHighlights2, 0,
